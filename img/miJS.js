...
//	var urlphpgf ="http://msnzapps.com/coleccion/kamasutra/phpcalls/php_numrow.php";
	
//		$.get( urlphpgf, function( data ) {
//var numerodfilas=45;
//		}, "json" );
		...
		//primero llamamos al php
	var urlasdf ="http://msnzapps.com/coleccion/kamasutra/phpcalls/php_kamasutra_lista_autocomplete.php";

	
	
		$.get( urlasdf, function( data ) {
